...
CandlestickSeries.defaultProps = {
	...
	// // wickStroke: "#ffffff",
	// wickStroke: d => d.close > d.open ? "#74c085" : "#f9999c",
	// fill: d => d.close > d.open ? "#4e855a" : "#a4444a",
	// stroke: d => d.close > d.open ? "#74c085" : "#f9999c",
  //
	wickStroke: d => d.close > d.open ? "#86de9a" : "#d38092",
	fill: d => d.close > d.open ? "#589666" : "#a4444a",
	// stroke: d => d.close > d.open ? "#86de9a" : "#d38092",
	// stroke: "#ffffff",
	candleStrokeWidth: 0,
	// stroke: "none",
	widthRatio: 0.8,
